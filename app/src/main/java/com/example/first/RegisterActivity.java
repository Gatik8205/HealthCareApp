                ...
                if(username.length()==0 || email.length()==0 || password.length()==0 || confirm.length()==0){
                    ...
                    if(password.compareTo(confirm)==0){
                        if(isValid(password)){
                            ...
                            Toast.makeText(getApplicationContext(), "Password must contains at least 8 character which should include digits,alphabets and special symbol", Toast.LENGTH_SHORT).show();
                        }
                    }else{
